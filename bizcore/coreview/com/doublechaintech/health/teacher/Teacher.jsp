<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.teacher.Teacher'%>
...
<c:set var="ownerBeanName" value="teacher" scope="request"/>
<c:set var="ownerClassName" value="Teacher" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="teacher" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/teacher/Teacher$Summary.jsp" />
