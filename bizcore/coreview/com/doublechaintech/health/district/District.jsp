<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.district.District'%>
...
<sky:include page="com/doublechaintech/health/district/District$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/city/City$Info.jsp" />
...
<sky:include page="com/doublechaintech/health/platform/Platform$Info.jsp" />
		...
		<div id="locationList" class="tab-pane fade sublist" refer-name="district">
			<sky:include page="com/doublechaintech/health/location/Location$List.jsp"
					referName="district"/>
		</div>
	</c:if>
