<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/health/userwhitelist/UserWhiteList$Summary.jsp" />
