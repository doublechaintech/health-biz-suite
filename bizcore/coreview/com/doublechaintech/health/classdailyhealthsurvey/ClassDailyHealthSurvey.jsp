<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.classdailyhealthsurvey.ClassDailyHealthSurvey'%>
...
<c:set var="ownerBeanName" value="classDailyHealthSurvey" scope="request"/>
<c:set var="ownerClassName" value="ClassDailyHealthSurvey" scope="request"/>
...
<div class="row">
	...
	<% ClassDailyHealthSurvey result = (ClassDailyHealthSurvey)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="classDailyHealthSurvey" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/classdailyhealthsurvey/ClassDailyHealthSurvey$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Info.jsp" />
		...
		<div id="dailySurveyQuestionList" class="tab-pane fade sublist" refer-name="class_daily_health_survey">
			<sky:include page="com/doublechaintech/health/dailysurveyquestion/DailySurveyQuestion$List.jsp"
					referName="classDailyHealthSurvey"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["studentHealthSurveyList"] or ignoreListAccessControl}'>
		...
		<div id="studentHealthSurveyList" class="tab-pane fade sublist" refer-name="class_daily_health_survey">
	...
	<c:if test='${not empty userContext.accessTokens["healthSurveyReportList"] or ignoreListAccessControl}'>
		...
		<div id="healthSurveyReportList" class="tab-pane fade sublist" refer-name="survey">
