...
<div class="col-xs-12 col-ms-4 col-md-3 action-section" >
	<b title="A UserDailyAnswer" style="color: green">${userContext.localeMap['user_daily_answer']}</b>
	<hr/>
	<ul>
	
	
	<li><span>${userContext.localeMap['user_daily_answer.id']}</span> ${userDailyAnswer.id}</li>
