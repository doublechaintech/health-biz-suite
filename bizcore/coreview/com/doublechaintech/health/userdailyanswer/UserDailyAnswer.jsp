<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.userdailyanswer.UserDailyAnswer'%>
...
<c:set var="ownerBeanName" value="userDailyAnswer" scope="request"/>
<c:set var="ownerClassName" value="UserDailyAnswer" scope="request"/>
...
<div class="row">
	...
	<% UserDailyAnswer result = (UserDailyAnswer)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#dailyAnswerList" class="disabled"> ${userContext.localeMap['daily_answer']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userDailyAnswer" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/userdailyanswer/UserDailyAnswer$Summary.jsp" />
...
<c:set var="dailyHealthSurvey" value="${ result.dailyHealthSurvey}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/dailyhealthsurvey/DailyHealthSurvey$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["dailyAnswerList"] or ignoreListAccessControl}'>
		<c:set var="dailyAnswerList" value="${result.dailyAnswerList}" scope="request"/>
		<c:set var="dailyAnswerListName" value="dailyAnswerList" scope="request"/>
		<div id="dailyAnswerList" class="tab-pane fade sublist" refer-name="user_daily_answer">
			<sky:include page="com/doublechaintech/health/dailyanswer/DailyAnswer$List.jsp"
					referName="userDailyAnswer"/>
		</div>
	</c:if>
