<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.supervisor.Supervisor'%>
...
<c:set var="ownerBeanName" value="supervisor" scope="request"/>
<c:set var="ownerClassName" value="Supervisor" scope="request"/>
...
<div class="row">
	...
	<% Supervisor result = (Supervisor)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#organizationList" class="disabled"> ${userContext.localeMap['organization']}</a></li>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="supervisor" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/supervisor/Supervisor$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/platform/Platform$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["organizationList"] or ignoreListAccessControl}'>
		<c:set var="organizationList" value="${result.organizationList}" scope="request"/>
		<c:set var="organizationListName" value="organizationList" scope="request"/>
		<div id="organizationList" class="tab-pane fade sublist" refer-name="supervisor">
			<sky:include page="com/doublechaintech/health/organization/Organization$List.jsp"
					referName="supervisor"/>
		</div>
	</c:if>
