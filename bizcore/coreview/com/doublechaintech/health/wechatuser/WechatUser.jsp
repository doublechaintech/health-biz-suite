<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.wechatuser.WechatUser'%>
...
<sky:include page="com/doublechaintech/health/wechatuser/WechatUser$Summary.jsp" />
...
<c:set var="userType" value="${ result.userType}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/usertype/UserType$Info.jsp" />
...
<sky:include page="com/doublechaintech/health/platform/Platform$Info.jsp" />
	...
	<c:if test='${not empty userContext.accessTokens["classQuestionList"] or ignoreListAccessControl}'>
		...
		<div id="classQuestionList" class="tab-pane fade sublist" refer-name="creator">
	...
	<c:if test='${not empty userContext.accessTokens["classDailyHealthSurveyList"] or ignoreListAccessControl}'>
		...
		<div id="classDailyHealthSurveyList" class="tab-pane fade sublist" refer-name="creator">
	...
	<c:if test='${not empty userContext.accessTokens["wechatLoginInfoList"] or ignoreListAccessControl}'>
		...
		<div id="wechatLoginInfoList" class="tab-pane fade sublist" refer-name="wechat_user">
			<sky:include page="com/doublechaintech/health/wechatlogininfo/WechatLoginInfo$List.jsp"
					referName="wechatUser"/>
		</div>
	</c:if>
