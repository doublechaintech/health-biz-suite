<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.guardian.Guardian'%>
...
<c:set var="ownerBeanName" value="guardian" scope="request"/>
<c:set var="ownerClassName" value="Guardian" scope="request"/>
...
<div class="row">
	...
	<% Guardian result = (Guardian)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="guardian" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/guardian/Guardian$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Info.jsp" />
		...
		<div id="studentList" class="tab-pane fade sublist" refer-name="guardian">
