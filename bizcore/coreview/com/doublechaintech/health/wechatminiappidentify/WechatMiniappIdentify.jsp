<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.wechatminiappidentify.WechatMiniappIdentify'%>
...
<sky:include page="com/doublechaintech/health/wechatminiappidentify/WechatMiniappIdentify$Summary.jsp" />
