<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.dailyanswer.DailyAnswer'%>
...
<c:set var="ownerBeanName" value="dailyAnswer" scope="request"/>
<c:set var="ownerClassName" value="DailyAnswer" scope="request"/>
...
<div class="row">
	...
	<% DailyAnswer result = (DailyAnswer)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="dailyAnswer" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/dailyanswer/DailyAnswer$Summary.jsp" />
	...
	<div class="row">
<c:set var="userDailyAnswer" value="${ result.userDailyAnswer}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/userdailyanswer/UserDailyAnswer$Info.jsp" />

<c:set var="userAnswer" value="${ result.userAnswer}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/useranswer/UserAnswer$Info.jsp" />
