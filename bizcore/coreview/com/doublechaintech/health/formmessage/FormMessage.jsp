<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/health/formmessage/FormMessage$Summary.jsp" />
