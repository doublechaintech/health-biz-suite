<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.questiontype.QuestionType'%>
...
<c:set var="ownerBeanName" value="questionType" scope="request"/>
<c:set var="ownerClassName" value="QuestionType" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="questionType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/questiontype/QuestionType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/platform/Platform$Info.jsp" />
	...
	<c:if test='${not empty userContext.accessTokens["dailySurveyQuestionList"] or ignoreListAccessControl}'>
		...
		<div id="dailySurveyQuestionList" class="tab-pane fade sublist" refer-name="question_type">
