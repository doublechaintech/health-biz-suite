<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/health/loginhistory/LoginHistory$Summary.jsp" />
