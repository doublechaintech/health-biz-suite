<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.schoolclass.SchoolClass'%>
...
<c:set var="ownerBeanName" value="schoolClass" scope="request"/>
<c:set var="ownerClassName" value="SchoolClass" scope="request"/>
...
<div class="row">
	...
	<% SchoolClass result = (SchoolClass)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="schoolClass" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/schoolclass/SchoolClass$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Info.jsp" />
		...
		<div id="classDailyHealthSurveyList" class="tab-pane fade sublist" refer-name="school_class">
			<sky:include page="com/doublechaintech/health/classdailyhealthsurvey/ClassDailyHealthSurvey$List.jsp"
					referName="schoolClass"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["studentList"] or ignoreListAccessControl}'>
		...
		<div id="studentList" class="tab-pane fade sublist" refer-name="school_class">
	...
	<c:if test='${not empty userContext.accessTokens["studentHealthSurveyList"] or ignoreListAccessControl}'>
		...
		<div id="studentHealthSurveyList" class="tab-pane fade sublist" refer-name="school_class">
