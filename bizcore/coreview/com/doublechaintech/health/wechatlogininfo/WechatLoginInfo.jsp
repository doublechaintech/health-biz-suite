<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.wechatlogininfo.WechatLoginInfo'%>
...
<sky:include page="com/doublechaintech/health/wechatlogininfo/WechatLoginInfo$Summary.jsp" />
