<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.questionsource.QuestionSource'%>
...
<c:set var="ownerBeanName" value="questionSource" scope="request"/>
<c:set var="ownerClassName" value="QuestionSource" scope="request"/>
...
<div class="row">
	...
	<% QuestionSource result = (QuestionSource)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="questionSource" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/questionsource/QuestionSource$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/platform/Platform$Info.jsp" />
		...
		<div id="classQuestionList" class="tab-pane fade sublist" refer-name="question_source">
			<sky:include page="com/doublechaintech/health/classquestion/ClassQuestion$List.jsp"
					referName="questionSource"/>
		</div>
	</c:if>
