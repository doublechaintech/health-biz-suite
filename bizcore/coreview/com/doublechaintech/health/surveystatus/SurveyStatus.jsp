<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.surveystatus.SurveyStatus'%>
...
<c:set var="ownerBeanName" value="surveyStatus" scope="request"/>
<c:set var="ownerClassName" value="SurveyStatus" scope="request"/>
...
<div class="row">
	...
	<% SurveyStatus result = (SurveyStatus)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="surveyStatus" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/surveystatus/SurveyStatus$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/platform/Platform$Info.jsp" />
		...
		<div id="studentHealthSurveyList" class="tab-pane fade sublist" refer-name="survey_status">
			<sky:include page="com/doublechaintech/health/studenthealthsurvey/StudentHealthSurvey$List.jsp"
					referName="surveyStatus"/>
		</div>
	</c:if>
