<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.city.City'%>
...
<sky:include page="com/doublechaintech/health/city/City$Summary.jsp" />
