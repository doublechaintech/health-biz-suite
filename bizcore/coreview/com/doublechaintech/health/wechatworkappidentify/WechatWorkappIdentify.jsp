<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.wechatworkappidentify.WechatWorkappIdentify'%>
...
<sky:include page="com/doublechaintech/health/wechatworkappidentify/WechatWorkappIdentify$Summary.jsp" />
