<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.changerequest.ChangeRequest'%>
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/changerequesttype/ChangeRequestType$Info.jsp" />
