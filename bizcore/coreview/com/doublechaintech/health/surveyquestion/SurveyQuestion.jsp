<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.surveyquestion.SurveyQuestion'%>
...
<c:set var="ownerBeanName" value="surveyQuestion" scope="request"/>
<c:set var="ownerClassName" value="SurveyQuestion" scope="request"/>
...
<div class="row">
	...
	<% SurveyQuestion result = (SurveyQuestion)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="surveyQuestion" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/surveyquestion/SurveyQuestion$Summary.jsp" />
	...
	<div class="row">
<c:set var="dailyHealthSurvey" value="${ result.survey}" scope="request" />
