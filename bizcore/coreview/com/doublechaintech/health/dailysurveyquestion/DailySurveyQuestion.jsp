<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.dailysurveyquestion.DailySurveyQuestion'%>
...
<c:set var="ownerBeanName" value="dailySurveyQuestion" scope="request"/>
<c:set var="ownerClassName" value="DailySurveyQuestion" scope="request"/>
...
<div class="row">
	...
	<% DailySurveyQuestion result = (DailySurveyQuestion)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="dailySurveyQuestion" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/dailysurveyquestion/DailySurveyQuestion$Summary.jsp" />
	...
	<div class="row">
<c:set var="questionType" value="${ result.questionType}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/questiontype/QuestionType$Info.jsp" />

<c:set var="classDailyHealthSurvey" value="${ result.classDailyHealthSurvey}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/classdailyhealthsurvey/ClassDailyHealthSurvey$Info.jsp" />

<c:set var="question" value="${ result.surveyQuestion}" scope="request" />
<c:set var="referName" value="(surveyQuestion)" scope="request" />
<sky:include page="com/doublechaintech/health/question/Question$Info.jsp" />
		...
		<div id="studentDailyAnswerList" class="tab-pane fade sublist" refer-name="question">
