...
<li><span>${userContext.localeMap['change_request_type.bind_types']}</span> ${changeRequestType.bindTypes}</li>
<li><span>${userContext.localeMap['change_request_type.step_configuration']}</span> ${changeRequestType.stepConfiguration}</li>
