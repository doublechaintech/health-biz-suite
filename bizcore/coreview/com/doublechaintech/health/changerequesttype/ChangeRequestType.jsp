<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.changerequesttype.ChangeRequestType'%>
...
<sky:include page="com/doublechaintech/health/changerequesttype/ChangeRequestType$Summary.jsp" />
