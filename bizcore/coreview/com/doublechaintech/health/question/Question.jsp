<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.question.Question'%>
...
<sky:include page="com/doublechaintech/health/question/Question$Summary.jsp" />
