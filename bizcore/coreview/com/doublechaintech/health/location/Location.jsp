<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.location.Location'%>
...
<c:set var="ownerBeanName" value="location" scope="request"/>
<c:set var="ownerClassName" value="Location" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="location" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/location/Location$Summary.jsp" />
...
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/province/Province$Info.jsp" />
