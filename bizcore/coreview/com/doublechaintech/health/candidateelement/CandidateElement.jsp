<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.candidateelement.CandidateElement'%>
...
<sky:include page="com/doublechaintech/health/candidateelement/CandidateElement$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/candidatecontainer/CandidateContainer$Info.jsp" />
