<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.formaction.FormAction'%>
...
<sky:include page="com/doublechaintech/health/formaction/FormAction$Summary.jsp" />
