<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.parent.Parent'%>
...
<c:set var="ownerBeanName" value="parent" scope="request"/>
<c:set var="ownerClassName" value="Parent" scope="request"/>
...
<div class="row">
	...
	<% Parent result = (Parent)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="parent" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/parent/Parent$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Info.jsp" />
		...
		<div id="studentList" class="tab-pane fade sublist" refer-name="parent">
