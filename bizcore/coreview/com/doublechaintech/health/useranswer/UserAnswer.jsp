<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.useranswer.UserAnswer'%>
...
<sky:include page="com/doublechaintech/health/useranswer/UserAnswer$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/question/Question$Info.jsp" />
		...
		<div id="dailyAnswerList" class="tab-pane fade sublist" refer-name="user_answer">
	...
	<c:if test='${not empty userContext.accessTokens["answerQuestionList"] or ignoreListAccessControl}'>
		...
		<div id="answerQuestionList" class="tab-pane fade sublist" refer-name="user_answer">
			<sky:include page="com/doublechaintech/health/answerquestion/AnswerQuestion$List.jsp"
					referName="userAnswer"/>
		</div>
	</c:if>
