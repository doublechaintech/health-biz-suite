<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.userapp.UserApp'%>
...
<sky:include page="com/doublechaintech/health/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/secuser/SecUser$Info.jsp" />
		...
		<div id="quickLinkList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/health/quicklink/QuickLink$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["listAccessList"] or ignoreListAccessControl}'>
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/health/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/health/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
