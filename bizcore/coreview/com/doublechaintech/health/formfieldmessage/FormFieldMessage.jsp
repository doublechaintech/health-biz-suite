<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.formfieldmessage.FormFieldMessage'%>
...
<sky:include page="com/doublechaintech/health/formfieldmessage/FormFieldMessage$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/genericform/GenericForm$Info.jsp" />
