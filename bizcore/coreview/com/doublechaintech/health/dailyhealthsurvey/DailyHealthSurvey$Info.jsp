...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<b title="A DailyHealthSurvey">${userContext.localeMap['daily_health_survey']} ${referName}</b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./dailyHealthSurveyManager/view/${dailyHealthSurvey.id}/"> ${dailyHealthSurvey.id}</a></li>
