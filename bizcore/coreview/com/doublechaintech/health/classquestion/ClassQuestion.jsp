<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.classquestion.ClassQuestion'%>
...
<c:set var="ownerBeanName" value="classQuestion" scope="request"/>
<c:set var="ownerClassName" value="ClassQuestion" scope="request"/>
...
<div class="row">
	...
	<% ClassQuestion result = (ClassQuestion)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="classQuestion" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/classquestion/ClassQuestion$Summary.jsp" />
...
<c:set var="questionSource" value="${ result.questionSource}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/questionsource/QuestionSource$Info.jsp" />
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Info.jsp" />
		...
		<div id="dailySurveyQuestionList" class="tab-pane fade sublist" refer-name="class_question">
			<sky:include page="com/doublechaintech/health/dailysurveyquestion/DailySurveyQuestion$List.jsp"
					referName="classQuestion"/>
		</div>
	</c:if>
