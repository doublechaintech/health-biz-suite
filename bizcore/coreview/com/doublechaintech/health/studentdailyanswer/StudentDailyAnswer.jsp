<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.studentdailyanswer.StudentDailyAnswer'%>
...
<c:set var="ownerBeanName" value="studentDailyAnswer" scope="request"/>
<c:set var="ownerClassName" value="StudentDailyAnswer" scope="request"/>
...
<div class="row">
	...
	<% StudentDailyAnswer result = (StudentDailyAnswer)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="studentDailyAnswer" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/studentdailyanswer/StudentDailyAnswer$Summary.jsp" />
	...
	<div class="row">
<c:set var="studentHealthSurvey" value="${ result.studentHealthSurvey}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/studenthealthsurvey/StudentHealthSurvey$Info.jsp" />

<c:set var="dailySurveyQuestion" value="${ result.question}" scope="request" />
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Info.jsp" />
		...
		<div id="studentAnswerList" class="tab-pane fade sublist" refer-name="daily_answer">
			<sky:include page="com/doublechaintech/health/studentanswer/StudentAnswer$List.jsp"
					referName="dailyAnswer"/>
		</div>
	</c:if>
