<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.answerquestion.AnswerQuestion'%>
...
<sky:include page="com/doublechaintech/health/answerquestion/AnswerQuestion$Summary.jsp" />
