<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.usertype.UserType'%>
...
<c:set var="ownerBeanName" value="userType" scope="request"/>
<c:set var="ownerClassName" value="UserType" scope="request"/>
...
<div class="row">
	...
	<% UserType result = (UserType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/usertype/UserType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/platform/Platform$Info.jsp" />
		...
		<div id="wechatUserList" class="tab-pane fade sublist" refer-name="user_type">
