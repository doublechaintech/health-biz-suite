<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.studentanswer.StudentAnswer'%>
...
<c:set var="ownerBeanName" value="studentAnswer" scope="request"/>
<c:set var="ownerClassName" value="StudentAnswer" scope="request"/>
...
<div class="row">
	...
	<% StudentAnswer result = (StudentAnswer)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="studentAnswer" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/studentanswer/StudentAnswer$Summary.jsp" />
	...
	<div class="row">
<c:set var="healthSurveyReport" value="${ result.healthSurveyReport}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/healthsurveyreport/HealthSurveyReport$Info.jsp" />

<c:set var="studentDailyAnswer" value="${ result.dailyAnswer}" scope="request" />
<c:set var="referName" value="(dailyAnswer)" scope="request" />
<sky:include page="com/doublechaintech/health/studentdailyanswer/StudentDailyAnswer$Info.jsp" />
