<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.student.Student'%>
...
<c:set var="ownerBeanName" value="student" scope="request"/>
<c:set var="ownerClassName" value="Student" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="student" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/student/Student$Summary.jsp" />
	...
	<div class="row">
<c:set var="guardian" value="${ result.guardian}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/guardian/Guardian$Info.jsp" />
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Info.jsp" />
		...
		<div id="studentHealthSurveyList" class="tab-pane fade sublist" refer-name="student">
