<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.studenthealthsurvey.StudentHealthSurvey'%>
...
<c:set var="ownerBeanName" value="studentHealthSurvey" scope="request"/>
<c:set var="ownerClassName" value="StudentHealthSurvey" scope="request"/>
...
<div class="row">
	...
	<% StudentHealthSurvey result = (StudentHealthSurvey)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="studentHealthSurvey" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/studenthealthsurvey/StudentHealthSurvey$Summary.jsp" />
...
<c:set var="surveyStatus" value="${ result.surveyStatus}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/health/surveystatus/SurveyStatus$Info.jsp" />
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Info.jsp" />
		...
		<div id="studentDailyAnswerList" class="tab-pane fade sublist" refer-name="student_health_survey">
			<sky:include page="com/doublechaintech/health/studentdailyanswer/StudentDailyAnswer$List.jsp"
					referName="studentHealthSurvey"/>
		</div>
	</c:if>
