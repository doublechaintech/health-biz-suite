<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.objectaccess.ObjectAccess'%>
...
<sky:include page="com/doublechaintech/health/objectaccess/ObjectAccess$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/userapp/UserApp$Info.jsp" />
