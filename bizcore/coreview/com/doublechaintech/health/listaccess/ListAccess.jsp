<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/health/listaccess/ListAccess$Summary.jsp" />
