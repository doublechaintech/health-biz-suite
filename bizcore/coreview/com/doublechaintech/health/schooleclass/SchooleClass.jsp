<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.schooleclass.SchooleClass'%>
...
<c:set var="ownerBeanName" value="schooleClass" scope="request"/>
<c:set var="ownerClassName" value="SchooleClass" scope="request"/>
...
<div class="row">
	...
	<% SchooleClass result = (SchooleClass)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="schooleClass" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/health/schooleclass/SchooleClass$Summary.jsp" />
	...
	<div class="row">
<c:set var="teacher" value="${ result.classTeacher}" scope="request" />
<c:set var="referName" value="(classTeacher)" scope="request" />
...
<sky:include page="com/doublechaintech/health/changerequest/ChangeRequest$Info.jsp" />
		...
		<div id="classDailyHealthSurveyList" class="tab-pane fade sublist" refer-name="schoole_class">
			<sky:include page="com/doublechaintech/health/classdailyhealthsurvey/ClassDailyHealthSurvey$List.jsp"
					referName="schooleClass"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["studentList"] or ignoreListAccessControl}'>
		...
		<div id="studentList" class="tab-pane fade sublist" refer-name="schoole_class">
	...
	<c:if test='${not empty userContext.accessTokens["studentHealthSurveyList"] or ignoreListAccessControl}'>
		...
		<div id="studentHealthSurveyList" class="tab-pane fade sublist" refer-name="schoole_class">
