<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.province.Province'%>
...
<sky:include page="com/doublechaintech/health/province/Province$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/platform/Platform$Info.jsp" />
	...
	<c:if test='${not empty userContext.accessTokens["locationList"] or ignoreListAccessControl}'>
		...
		<div id="locationList" class="tab-pane fade sublist" refer-name="province">
