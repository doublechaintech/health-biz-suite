<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.user.User'%>
...
<sky:include page="com/doublechaintech/health/user/User$Summary.jsp" />
...
<sky:include page="com/doublechaintech/health/platform/Platform$Info.jsp" />
	...
	<c:if test='${not empty userContext.accessTokens["questionList"] or ignoreListAccessControl}'>
		...
		<div id="questionList" class="tab-pane fade sublist" refer-name="creator">
	...
	<c:if test='${not empty userContext.accessTokens["wechatLoginInfoList"] or ignoreListAccessControl}'>
		...
		<div id="wechatLoginInfoList" class="tab-pane fade sublist" refer-name="user">
