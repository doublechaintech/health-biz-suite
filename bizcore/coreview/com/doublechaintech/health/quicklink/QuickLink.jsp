<%@ page import='java.util.*,com.doublechaintech.health.*,com.doublechaintech.health.quicklink.QuickLink'%>
...
<sky:include page="com/doublechaintech/health/quicklink/QuickLink$Summary.jsp" />
