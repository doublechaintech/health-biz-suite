...
public class StudentDailyAnswerTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_STUDENT_HEALTH_SURVEY,COLUMN_QUESTION,COLUMN_ANSWER,COLUMN_CREATE_TIME,COLUMN_LAST_UPDATE_TIME,COLUMN_CQ,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_STUDENT_HEALTH_SURVEY,COLUMN_QUESTION,COLUMN_ANSWER,COLUMN_CREATE_TIME,COLUMN_LAST_UPDATE_TIME,COLUMN_CQ};
