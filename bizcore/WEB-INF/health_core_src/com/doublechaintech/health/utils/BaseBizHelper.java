package com.doublechaintech.health.utils;
...
public class BaseBizHelper {
	protected CustomHealthUserContextImpl userContext;
	protected static final Map<String, Object> EO = new HashMap<>();
	protected Map<String, Object> cache;
	
	public CustomHealthUserContextImpl getUserContext() {
		return userContext;
	}
	public void setUserContext(CustomHealthUserContextImpl userContext) {
		this.userContext = userContext;
	}

	protected static <T extends BaseBizHelper> T _OF(CustomHealthUserContextImpl ctx, Class<T> clazz) {
		return _OF(ctx, clazz, false);
	}
			
	protected static <T extends BaseBizHelper> T _OF(CustomHealthUserContextImpl ctx,
