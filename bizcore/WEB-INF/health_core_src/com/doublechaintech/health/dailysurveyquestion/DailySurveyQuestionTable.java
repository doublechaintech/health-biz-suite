...
public class DailySurveyQuestionTable{
	...
	static final String COLUMN_CLASS_QUESTION = "class_question";
	static final String COLUMN_VERSION = "version";
 
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_TOPIC,COLUMN_QUESTION_TYPE,COLUMN_OPTION_A,COLUMN_OPTION_B,COLUMN_OPTION_C,COLUMN_OPTION_D,COLUMN_CLASS_DAILY_HEALTH_SURVEY,COLUMN_CLASS_QUESTION,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_TOPIC,COLUMN_QUESTION_TYPE,COLUMN_OPTION_A,COLUMN_OPTION_B,COLUMN_OPTION_C,COLUMN_OPTION_D,COLUMN_CLASS_DAILY_HEALTH_SURVEY,COLUMN_CLASS_QUESTION};
