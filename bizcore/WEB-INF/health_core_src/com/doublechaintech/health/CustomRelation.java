...
public class CustomRelation extends BaseRelation{
	...
	protected void prepareRelation()
	{
		...
		//replaceGenericRelation("Teacher"                               , BaseRelation.TRUST_CHAIN_ALL, "changeRequest");
		...
		//replaceGenericRelation("Student"                               , BaseRelation.TRUST_CHAIN_ALL, "changeRequest");
		...
		//replaceGenericRelation("ClassDailyHealthSurvey"                , BaseRelation.TRUST_CHAIN_ALL, "changeRequest");
		...
		//replaceGenericRelation("StudentHealthSurvey"                   , BaseRelation.TRUST_CHAIN_ALL, "changeRequest");
		...
		//replaceGenericRelation("StudentDailyAnswer"                    , BaseRelation.TRUST_CHAIN_ALL, "changeRequest");
