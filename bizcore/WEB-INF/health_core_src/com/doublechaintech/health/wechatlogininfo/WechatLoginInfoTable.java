...
public class WechatLoginInfoTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_USER,COLUMN_APP_ID,COLUMN_OPEN_ID,COLUMN_SESSION_KEY,COLUMN_LAST_UPDATE_TIME,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_USER,COLUMN_APP_ID,COLUMN_OPEN_ID,COLUMN_SESSION_KEY,COLUMN_LAST_UPDATE_TIME};
