...
public class GenericFormJDBCTemplateDAO extends HealthBaseDAOImpl implements GenericFormDAO{
	...
	*/
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormMessage(HealthUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormFieldMessage(HealthUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormField(HealthUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormAction(HealthUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
	...
	public SmartList<FormMessage> loadOurFormMessageList(HealthUserContext userContext, List<GenericForm> us, Map<String,Object> options) throws Exception{
	...
	public SmartList<FormFieldMessage> loadOurFormFieldMessageList(HealthUserContext userContext, List<GenericForm> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
	...
	public SmartList<FormField> loadOurFormFieldList(HealthUserContext userContext, List<GenericForm> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
	...
	public SmartList<FormAction> loadOurFormActionList(HealthUserContext userContext, List<GenericForm> us, Map<String,Object> options) throws Exception{
		if (us == null || us.isEmpty()){
			return new SmartList<>();
		}
		Set<String> ids = us.stream().map(it->it.getId()).collect(Collectors.toSet());
