...
public interface LocationManager extends BaseManager{
	...
	//public  StudentManager getStudentManager(HealthUserContext userContext, String locationId, String studentName, String studentId, String guardianName, String guardianMobile, String userId, String platformId, String cqId ,String [] tokensExpr)  throws Exception;
