...
import com.doublechaintech.health.secuser.SecUserCustomManagerImpl;
import com.doublechaintech.health.userapp.UserApp;
import com.doublechaintech.health.userapp.UserAppTokens;
import com.terapico.utils.CollectionUtils;

public class HealthUserContextImpl extends UserContextImpl implements HealthUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.health.HealthResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.health.HealthCustomResources";
    ...
    /*
    public static SecUser getSecUser(HealthUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(HealthUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(HealthUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(HealthUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private HealthObjectChecker checker;
