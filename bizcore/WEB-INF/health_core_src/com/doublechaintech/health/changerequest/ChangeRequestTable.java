...
public class ChangeRequestTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_CREATE_TIME,COLUMN_REMOTE_IP,COLUMN_REQUEST_TYPE,COLUMN_PLATFORM,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_CREATE_TIME,COLUMN_REMOTE_IP,COLUMN_REQUEST_TYPE,COLUMN_PLATFORM};
