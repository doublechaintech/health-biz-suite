...
public class ClassDailyHealthSurveyTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_TEACHER,COLUMN_SURVEY_TIME,COLUMN_CREATOR,COLUMN_DOWNLOAD_URL,COLUMN_CHANGE_REQUEST,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_TEACHER,COLUMN_SURVEY_TIME,COLUMN_CREATOR,COLUMN_DOWNLOAD_URL,COLUMN_CHANGE_REQUEST};
