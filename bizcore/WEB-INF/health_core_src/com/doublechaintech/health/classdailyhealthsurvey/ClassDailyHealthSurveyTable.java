...
public class ClassDailyHealthSurveyTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_SCHOOL_CLASS,COLUMN_SURVEY_TIME,COLUMN_CREATOR,COLUMN_CQ,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_SCHOOL_CLASS,COLUMN_SURVEY_TIME,COLUMN_CREATOR,COLUMN_CQ};
