...
public class QuickLinkManagerImpl extends CustomHealthCheckerManager implements QuickLinkManager, BusinessHandler{
	...
	@Override
	public QuickLinkDAO daoOf(HealthUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws QuickLinkManagerException{
 	...
 	protected QuickLink saveQuickLink(HealthUserContext userContext, QuickLink quickLink, String [] tokensExpr) throws Exception{	
 	...
 	protected QuickLink saveQuickLinkDetail(HealthUserContext userContext, QuickLink quickLink) throws Exception{	
 	...
 	public QuickLink loadQuickLink(HealthUserContext userContext, String quickLinkId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public QuickLink searchQuickLink(HealthUserContext userContext, String quickLinkId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected QuickLink present(HealthUserContext userContext, QuickLink quickLink, Map<String, Object> tokens) throws Exception {
 	...
 	public QuickLink loadQuickLinkDetail(HealthUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, allTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	
 	public Object view(HealthUserContext userContext, String quickLinkId) throws Exception{	
 		QuickLink quickLink = loadQuickLink( userContext, quickLinkId, viewTokens());
 		return present(userContext,quickLink, allTokens());
		
 	}
 	protected QuickLink saveQuickLink(HealthUserContext userContext, QuickLink quickLink, Map<String,Object>tokens) throws Exception{	
 		return quickLinkDaoOf(userContext).save(quickLink, tokens);
 	}
 	protected QuickLink loadQuickLink(HealthUserContext userContext, String quickLinkId, Map<String,Object>tokens) throws Exception{	
		checkerOf(userContext).checkIdOfQuickLink(quickLinkId);
		checkerOf(userContext).throwExceptionIfHasErrors( QuickLinkManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(HealthUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(HealthUserContext userContext, QuickLink quickLink, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingQuickLink(HealthUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public QuickLink clone(HealthUserContext userContext, String fromQuickLinkId) throws Exception{
	...
	public QuickLink internalSaveQuickLink(HealthUserContext userContext, QuickLink quickLink, Map<String,Object> options) throws Exception
	{
	...
	public QuickLink updateQuickLinkProperty(HealthUserContext userContext,String quickLinkId, int quickLinkVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingQuickLink(userContext, quickLinkId, quickLinkVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(HealthUserContext userContext, String quickLinkId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(HealthUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
	...
	public QuickLink forgetByAll(HealthUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
		return forgetByAllInternal(userContext, quickLinkId, quickLinkVersion);
	}
	protected QuickLink forgetByAllInternal(HealthUserContext userContext,
			String quickLinkId, int quickLinkVersion) throws Exception{
