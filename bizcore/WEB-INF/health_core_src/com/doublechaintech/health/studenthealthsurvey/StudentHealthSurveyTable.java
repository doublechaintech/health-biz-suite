...
public class StudentHealthSurveyTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_STUDENT,COLUMN_ANSWER_TIME,COLUMN_SURVEY_STATUS,COLUMN_SCHOOL_CLASS,COLUMN_CLASS_DAILY_HEALTH_SURVEY,COLUMN_CREATE_TIME,COLUMN_LAST_UPDATE_TIME,COLUMN_CQ,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_STUDENT,COLUMN_ANSWER_TIME,COLUMN_SURVEY_STATUS,COLUMN_SCHOOL_CLASS,COLUMN_CLASS_DAILY_HEALTH_SURVEY,COLUMN_CREATE_TIME,COLUMN_LAST_UPDATE_TIME,COLUMN_CQ};
