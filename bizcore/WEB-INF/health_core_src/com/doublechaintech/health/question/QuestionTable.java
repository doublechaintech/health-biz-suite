...
public class QuestionTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_TOPIC,COLUMN_QUESTION_TYPE,COLUMN_OPTION_A,COLUMN_OPTION_B,COLUMN_OPTION_C,COLUMN_OPTION_D,COLUMN_PLATFORM,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_TOPIC,COLUMN_QUESTION_TYPE,COLUMN_OPTION_A,COLUMN_OPTION_B,COLUMN_OPTION_C,COLUMN_OPTION_D,COLUMN_PLATFORM};
