...
public class CandidateContainerJDBCTemplateDAO extends HealthBaseDAOImpl implements CandidateContainerDAO{
	...
	*/
    ...
    public SmartList<CandidateContainer> requestCandidateCandidateContainerForCandidateElement(HealthUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<CandidateElement> loadOurCandidateElementList(HealthUserContext userContext, List<CandidateContainer> us, Map<String,Object> options) throws Exception{
