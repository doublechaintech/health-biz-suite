...
public class TeacherTable{
	...
	static final String COLUMN_CLASS_SIZE = "class_size";
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_MOBILE,COLUMN_SCHOOL,COLUMN_SCHOOL_CLASS,COLUMN_CLASS_SIZE,COLUMN_CREATE_TIME,COLUMN_PLATFORM,COLUMN_USER,COLUMN_CHANGE_REQUEST,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_MOBILE,COLUMN_SCHOOL,COLUMN_SCHOOL_CLASS,COLUMN_CLASS_SIZE,COLUMN_CREATE_TIME,COLUMN_PLATFORM,COLUMN_USER,COLUMN_CHANGE_REQUEST};
