...
public class HealthNamingServiceDAO extends CommonJDBCTemplateDAO {
	...
	static {
		...
		namingTableMap.put("Location", new String[]{"location_data","name"});
		namingTableMap.put("SchoolClass", new String[]{"school_class_data","name"});
		namingTableMap.put("Teacher", new String[]{"teacher_data","name"});
		namingTableMap.put("Guardian", new String[]{"guardian_data","name"});
		namingTableMap.put("Question", new String[]{"question_data","topic"});
		namingTableMap.put("QuestionType", new String[]{"question_type_data","name"});
		namingTableMap.put("QuestionSource", new String[]{"question_source_data","name"});
		namingTableMap.put("ClassQuestion", new String[]{"class_question_data","topic"});
		namingTableMap.put("ClassDailyHealthSurvey", new String[]{"class_daily_health_survey_data","name"});
		namingTableMap.put("DailySurveyQuestion", new String[]{"daily_survey_question_data","topic"});
		namingTableMap.put("Student", new String[]{"student_data","name"});
		...
		namingTableMap.put("UserType", new String[]{"user_type_data","name"});
