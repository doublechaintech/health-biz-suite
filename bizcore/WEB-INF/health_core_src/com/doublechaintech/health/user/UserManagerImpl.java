...
public class UserManagerImpl extends CustomHealthCheckerManager implements UserManager, BusinessHandler{
 ...
 //--------------------------------------------------------------
	...
	protected User breakWithStudentByCq(HealthUserContext userContext, String userId, String cqId,  String [] tokensExpr)
		 throws Exception{
			...
			synchronized(user){
				...
				userDaoOf(userContext).planToRemoveStudentListWithCq(user, cqId, this.emptyOptions());
	...
	protected User breakWithClassDailyHealthSurveyByCq(HealthUserContext userContext, String userId, String cqId,  String [] tokensExpr)
		 throws Exception{
			...
			synchronized(user){
				...
				userDaoOf(userContext).planToRemoveClassDailyHealthSurveyListWithCq(user, cqId, this.emptyOptions());
	...
	protected void checkParamsForAddingStudent(HealthUserContext userContext, String userId, String studentName, String studentId, String guardianName, String guardianMobile, String addressId, String platformId, String cqId,String [] tokensExpr) throws Exception{
	...
	public  User addStudent(HealthUserContext userContext, String userId, String studentName, String studentId, String guardianName, String guardianMobile, String addressId, String platformId, String cqId, String [] tokensExpr) throws Exception
	{

		checkParamsForAddingStudent(userContext,userId,studentName, studentId, guardianName, guardianMobile, addressId, platformId, cqId,tokensExpr);

		Student student = createStudent(userContext,studentName, studentId, guardianName, guardianMobile, addressId, platformId, cqId);
	...
	protected Student createStudent(HealthUserContext userContext, String studentName, String studentId, String guardianName, String guardianMobile, String addressId, String platformId, String cqId) throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingClassDailyHealthSurvey(HealthUserContext userContext, String userId, String name, String teacherId, DateTime surveyTime, String cqId,String [] tokensExpr) throws Exception{
	...
	public  User addClassDailyHealthSurvey(HealthUserContext userContext, String userId, String name, String teacherId, DateTime surveyTime, String cqId, String [] tokensExpr) throws Exception
	{

		checkParamsForAddingClassDailyHealthSurvey(userContext,userId,name, teacherId, surveyTime, cqId,tokensExpr);

		ClassDailyHealthSurvey classDailyHealthSurvey = createClassDailyHealthSurvey(userContext,name, teacherId, surveyTime, cqId);
	...
	protected ClassDailyHealthSurvey createClassDailyHealthSurvey(HealthUserContext userContext, String name, String teacherId, DateTime surveyTime, String cqId) throws Exception{
