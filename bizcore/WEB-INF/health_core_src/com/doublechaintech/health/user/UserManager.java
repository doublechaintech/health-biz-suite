...
public interface UserManager extends BaseManager{
	...
	//public  StudentManager getStudentManager(HealthUserContext userContext, String userId, String studentName, String studentId, String guardianName, String guardianMobile, String addressId, String platformId, String cqId ,String [] tokensExpr)  throws Exception;
	...
	*/
	...
	//public  ClassDailyHealthSurveyManager getClassDailyHealthSurveyManager(HealthUserContext userContext, String userId, String name, String teacherId, DateTime surveyTime, String cqId ,String [] tokensExpr)  throws Exception;
