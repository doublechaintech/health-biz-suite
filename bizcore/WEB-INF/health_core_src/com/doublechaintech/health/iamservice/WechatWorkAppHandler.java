...
public class WechatWorkAppHandler extends BaseIdentificationHandler {
	...
	@Override
	public LoginResult authenticate(HealthUserContext userContext, LoginContext loginContext) {
	...
	protected SmartList<WechatWorkappIdentify> getIdentifyRecords(HealthUserContext userContext,
	...
	protected boolean authenticateWithCode(HealthUserContext userContext, String code, LoginResult result) throws Exception {
	...
	@Override
	public void bindWithSecUser(HealthUserContext userContext, LoginContext loginContext) throws Exception {
