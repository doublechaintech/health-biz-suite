...
import com.doublechaintech.health.LoginForm;
import com.doublechaintech.health.BaseEntity;
import com.doublechaintech.health.CommonError;
import com.doublechaintech.health.DAOGroup;
import com.doublechaintech.health.ManagerGroup;

import com.doublechaintech.health.UserContextImpl;
import com.doublechaintech.health.userapp.UserApp;
import com.doublechaintech.health.HealthUserContext;
import com.doublechaintech.health.userapp.*;
import com.doublechaintech.health.listaccess.*;
import com.doublechaintech.health.objectaccess.*;
import com.doublechaintech.health.HealthObjectChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
   ...
   public void setBlockChainAdvancer(BlockChainAdvancer pBlockChainAdvancer){
    ...
    public String confirmSession(HealthUserContext userContext){
    ...
    public Object resetPassword(HealthUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(HealthUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(HealthUserContext userContext,
    ...
    public SecUser manage(HealthUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(HealthUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }

    public SecUser getCachedSecUser(HealthUserContext userContext) {
    ...
    protected Object gotoApp(HealthUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(HealthUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(HealthUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(HealthUserContext userContex, int length){
    ...
    protected String getBeanName(HealthUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(HealthUserContext userContext, UserApp app){

        return  app.getObjectId();

    }
    protected String getServiceType(HealthUserContext userContext, UserApp app){

        return app.getObjectType();
    }
    protected String getMethodName(HealthUserContext userContext, UserApp app){
    ...
    public Object home(HealthUserContext userContext) {
    ...
    public Object loginWithEmail(HealthUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);

    }
    public Object login(HealthUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(HealthUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);

    }
    public Object loginWithMobile(HealthUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);

    }
    protected SecUser loadUserWith(HealthUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(HealthUserContext userContext, String type, String userId,
            Password password) {
     ...
     */
    protected Object loginTheSecUserInternal(HealthUserContext userContext, SecUser user, String loginComments) throws Exception {
		...
		iamService.onLoginSecUserInternalSuccess((HealthUserContextImpl) userContext, user);
    ...
    public Object showlogin(HealthUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(HealthUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        HealthUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected HealthObjectChecker checker;
    public HealthObjectChecker getChecker(){
        return checker;
    }

    public void setChecker(HealthObjectChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((HealthObjectChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected HealthUserContextImpl createNewConext(String path) {

        return new CustomHealthUserContextImpl();
    ...
    public Object checkOtherLogin(HealthUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(HealthUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(HealthUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(HealthUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(HealthUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(HealthUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(HealthUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(HealthUserContext userContext) throws SecUserManagerException {
