...
这个类已经被配置到了相应的Spring配置文件 WEB-INF/health_custom_src/META-INF/health_custom.xml 中，
...
public class ClassDailyHealthSurveyCustomManagerImpl extends ClassDailyHealthSurveyManagerImpl{
