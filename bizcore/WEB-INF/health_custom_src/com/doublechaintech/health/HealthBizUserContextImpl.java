...
public class HealthBizUserContextImpl extends HealthUserContextImpl{
	...
	protected BaseHealthFormProcessor inputFormData;
	protected BaseHealthFormProcessor outputFormData;
	...
	public String getPostMd5Key(HealthBizUserContextImpl ctx) {
	...
	public BaseHealthFormProcessor getInputFormData() {
		return inputFormData;
	}
	public void setInputFormData(BaseHealthFormProcessor inputFormData) {
		this.inputFormData = inputFormData;
	}
	public BaseHealthFormProcessor getOutputFormData() {
		return outputFormData;
	}
	public void setOutputFormData(BaseHealthFormProcessor outputFormData) {
