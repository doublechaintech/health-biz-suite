...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.SchooleClassBase.renderItemOfList(item, targetComponents)

}



class SchooleClassProfile extends Component {
...
}))(Form.create()(SchooleClassProfile))
