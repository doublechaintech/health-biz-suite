...
class SchooleClassSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      schooleClassList: 1,
      'schooleClassList.searchField': fieldName,
      'schooleClassList.searchVerb': 'startsWith',
      'schooleClassList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        schooleClassSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={SchooleClassService.requestCandidateClassTeacher} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={SchooleClassService.requestCandidatePlatform} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"cq"} 
                    requestFunction={SchooleClassService.requestCandidateCq} useForSearch />
...
export default Form.create()(SchooleClassSearchForm)
