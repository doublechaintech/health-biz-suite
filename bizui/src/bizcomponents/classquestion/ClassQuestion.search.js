...
import styles from './ClassQuestion.search.less'
import ListViewTool from '../../common/ListView.tool'
import ClassQuestionBase from './ClassQuestion.base'
import PermissionSettingService from '../../permission/PermissionSetting.service'
import appLocaleName from '../../common/Locale.tool'
const {fieldLabels} = ClassQuestionBase
...
const showAssociateDialog = (targetComponent) => {
  ...
  const { QuestionSourceAssociateForm } = GlobalComponents
  ...
  <div>
	...
	data={{classQuestionList:selectedRows}} owner={owner}  
	...
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'questionType')}/> <QuestionSourceAssociateForm 
	visible={currentAssociateModal==='questionSource'} 
	data={{classQuestionList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'questionSource')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'questionSource')}/> <ChangeRequestAssociateForm 
...
class ClassQuestionSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ClassQuestionTable} = GlobalComponents;
    const {ClassQuestionSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ClassQuestionSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ClassQuestionModalTable,"classQuestionIds")}
...
export default Form.create()(ClassQuestionSearch)
