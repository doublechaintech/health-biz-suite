...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.ClassQuestionBase.renderItemOfList(item, targetComponents)

}



class ClassQuestionProfile extends Component {
...
}))(Form.create()(ClassQuestionProfile))
