...
import styles from './ClassQuestion.createform.less'
...
class ClassQuestionCreateFormBody extends Component {
  state = {
  ...
  render() {
    ...
    const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"CreateNew")}{window.trans('class_question')}</div>)
    }
      ...
      <div>
        <Card title={!this.props.hideTitle&&appLocaleName(userContext,"BasicInfo")} className={styles.card} bordered={false}>
          <Form >
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.questionType} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={ClassQuestionService.requestCandidateQuestionType}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.questionSource} {...formItemLayout}>
                  {getFieldDecorator('questionSourceId', {
                  	initialValue: tryinit('questionSource'),
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
                  
                  <SelectObject 
                    disabled={!availableForEdit('questionSource')}
                    targetType={"questionSource"} 
                    requestFunction={ClassQuestionService.requestCandidateQuestionSource}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.creator} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"creator"} 
                    requestFunction={ClassQuestionService.requestCandidateCreator}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.cq} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"cq"} 
                    requestFunction={ClassQuestionService.requestCandidateCq}/>
...
}))(Form.create()(ClassQuestionCreateFormBody))
