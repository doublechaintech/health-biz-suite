...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{cityList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'province')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'province')}/> <PlatformAssociateForm 
  ...
  render(){
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,CityModalTable,"cityIds")}
