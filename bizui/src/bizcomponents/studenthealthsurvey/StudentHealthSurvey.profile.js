...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.StudentHealthSurveyBase.renderItemOfList(item, targetComponents)

}



class StudentHealthSurveyProfile extends Component {
...
}))(Form.create()(StudentHealthSurveyProfile))
