...
class StudentHealthSurveySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      studentHealthSurveyList: 1,
      'studentHealthSurveyList.searchField': fieldName,
      'studentHealthSurveyList.searchVerb': 'startsWith',
      'studentHealthSurveyList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        studentHealthSurveySearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                 <Form.Item label={fieldLabels.surveyStatus}>
               {getFieldDecorator('surveyStatus', {initialValue: tryinit('surveyStatus')})(
               
               <SelectObject 
                 disabled={!availableForEdit('surveyStatus')}
                 targetType={"surveyStatus"} 
                 requestFunction={StudentHealthSurveyService.requestCandidateSurveyStatus} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"student"} 
                    requestFunction={StudentHealthSurveyService.requestCandidateStudent} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={StudentHealthSurveyService.requestCandidateClassDailyHealthSurvey} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={StudentHealthSurveyService.requestCandidateChangeRequest} useForSearch />
...
export default Form.create()(StudentHealthSurveySearchForm)
