...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.UserDailyAnswerBase.renderItemOfList(item, targetComponents)

}



class UserDailyAnswerProfile extends Component {
...
}))(Form.create()(UserDailyAnswerProfile))
