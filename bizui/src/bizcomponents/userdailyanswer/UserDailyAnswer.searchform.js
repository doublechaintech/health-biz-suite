...
class UserDailyAnswerSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      userDailyAnswerList: 1,
      'userDailyAnswerList.searchField': fieldName,
      'userDailyAnswerList.searchVerb': 'startsWith',
      'userDailyAnswerList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'dailyHealthSurvey'))
      ...
      dispatch({
        ...
        userDailyAnswerSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"user"} 
                    requestFunction={UserDailyAnswerService.requestCandidateUser} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={UserDailyAnswerService.requestCandidateOrganization} useForSearch />
                  	
                 
                  )}
                </Form.Item></Col>
 <Col md={8} sm={24}>
                    <Form.Item label={fieldLabels.dailyHealthSurvey}>
                  {getFieldDecorator('dailyHealthSurvey', {initialValue: tryinit('dailyHealthSurvey')})(
                  
                  <SelectObject 
                    disabled={!availableForEdit('dailyHealthSurvey')}
                    targetType={"dailyHealthSurvey"} 
                    requestFunction={UserDailyAnswerService.requestCandidateDailyHealthSurvey} useForSearch />
...
export default Form.create()(UserDailyAnswerSearchForm)
