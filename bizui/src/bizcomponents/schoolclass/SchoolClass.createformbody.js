...
class SchoolClassCreateFormBody extends Component {
  state = {
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.classTeacher} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={SchoolClassService.requestCandidateClassTeacher}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.platform} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={SchoolClassService.requestCandidatePlatform}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.cq} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"cq"} 
                    requestFunction={SchoolClassService.requestCandidateCq}/>
...
}))(Form.create()(SchoolClassCreateFormBody))
