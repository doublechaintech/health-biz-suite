...
import styles from './SchoolClass.search.less'
import GlobalComponents from '../../custcomponents'
import SelectObject from '../../components/SelectObject'
import appLocaleName from '../../common/Locale.tool'
import SchoolClassBase from './SchoolClass.base'
const FormItem = Form.Item
const { Option } = Select
const getValue = obj => Object.keys(obj).map(key => obj[key]).join(',')
const {fieldLabels} = SchoolClassBase
...
class SchoolClassSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      schoolClassList: 1,
      'schoolClassList.searchField': fieldName,
      'schoolClassList.searchVerb': 'startsWith',
      'schoolClassList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'classTeacher'))
      ...
      dispatch({
        ...
        schoolClassSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                    <Form.Item label={fieldLabels.classTeacher}>
                  {getFieldDecorator('classTeacher', {initialValue: tryinit('classTeacher')})(
                  
                  <SelectObject 
                    disabled={!availableForEdit('classTeacher')}
                    targetType={"classTeacher"} 
                    requestFunction={SchoolClassService.requestCandidateClassTeacher} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={SchoolClassService.requestCandidatePlatform} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"cq"} 
                    requestFunction={SchoolClassService.requestCandidateCq} useForSearch />
...
export default Form.create()(SchoolClassSearchForm)
