...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.SchoolClassBase.renderItemOfList(item, targetComponents)

}



class SchoolClassProfile extends Component {
...
}))(Form.create()(SchoolClassProfile))
