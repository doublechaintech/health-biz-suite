...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{schoolClassList:selectedRows}} owner={owner}  
...
class SchoolClassSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SchoolClassTable} = GlobalComponents;
    const {SchoolClassSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SchoolClassSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SchoolClassModalTable,"schoolClassIds")}
...
export default Form.create()(SchoolClassSearch)
