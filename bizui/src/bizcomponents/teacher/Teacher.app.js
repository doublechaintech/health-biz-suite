...
class TeacherBizApp extends React.PureComponent {
    ...
    return (
      ...
      >
        <Menu.Item key="dashboard">
          <Link to={`/teacher/${this.props.teacher.id}/dashboard`}>
  ...
  buildRouters = () => {
    ...
    const routers = [
      ...
      {
        path: '/teacher/:id/list/classDailyHealthSurveyList',
        component: this.getClassDailyHealthSurveySearch(),
      },
      {
        path: '/teacher/:id/list/classDailyHealthSurveyCreateForm',
        component: this.getClassDailyHealthSurveyCreateForm(),
      },
      {
        path: '/teacher/:id/list/classDailyHealthSurveyUpdateForm',
        component: this.getClassDailyHealthSurveyUpdateForm(),
      },

      {
        path: '/teacher/:id/list/studentHealthSurveyList',
        component: this.getStudentHealthSurveySearch(),
      },
      {
        path: '/teacher/:id/list/studentHealthSurveyCreateForm',
        component: this.getStudentHealthSurveyCreateForm(),
      },
      {
        path: '/teacher/:id/list/studentHealthSurveyUpdateForm',
        component: this.getStudentHealthSurveyUpdateForm(),
      },

      {
        path: '/teacher/:id/list/healthSurveyReportList',
        component: this.getHealthSurveyReportSearch(),
      },
      {
        path: '/teacher/:id/list/healthSurveyReportCreateForm',
        component: this.getHealthSurveyReportCreateForm(),
      },
      {
        path: '/teacher/:id/list/healthSurveyReportUpdateForm',
        component: this.getHealthSurveyReportUpdateForm(),
      },
      {
        path: '/teacher/:id/ChangeRequestType/:code',
        ...
        <Layout style={{ marginTop: 44 }}>
          {this.state.showSearch && (
            <div style={{ backgroundColor: 'black' }} onClick={() => hideSearchResult()}>
              {searchLocalData(this.props.teacher, this.state.searchKeyword)}
            </div>
          )}
