...
import styles from './Teacher.search.less';
...
class TeacherSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      teacherList: 1,
      'teacherList.searchField': fieldName,
      'teacherList.searchVerb': 'startsWith',
      'teacherList.searchValue': fieldValue,
    }
  }
  */
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        payload: {
          id: owner.id,
          parameters: params,
          teacherSearchFormParameters: filterObjectKeys(fieldsValue),
