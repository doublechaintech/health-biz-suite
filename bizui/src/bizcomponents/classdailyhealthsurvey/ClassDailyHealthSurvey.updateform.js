...
import styles from './ClassDailyHealthSurvey.updateform.less'
...
class ClassDailyHealthSurveyUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const classDailyHealthSurveyId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, classDailyHealthSurveyId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateClassDailyHealthSurvey`,
          payload: {
            id: owner.id,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextClassDailyHealthSurveyUpdateRow`,
        payload: {
          id: owner.id,
          type: 'classDailyHealthSurvey',
          selectedRows,
...
}))(Form.create()(ClassDailyHealthSurveyUpdateForm))
