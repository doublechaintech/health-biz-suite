...
class ClassDailyHealthSurveySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      classDailyHealthSurveyList: 1,
      'classDailyHealthSurveyList.searchField': fieldName,
      'classDailyHealthSurveyList.searchVerb': 'startsWith',
      'classDailyHealthSurveyList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        classDailyHealthSurveySearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"teacher"} 
                    requestFunction={ClassDailyHealthSurveyService.requestCandidateTeacher} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"creator"} 
                    requestFunction={ClassDailyHealthSurveyService.requestCandidateCreator} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={ClassDailyHealthSurveyService.requestCandidateChangeRequest} useForSearch />
...
export default Form.create()(ClassDailyHealthSurveySearchForm)
