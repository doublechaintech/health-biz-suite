...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.ClassDailyHealthSurveyBase.renderItemOfList(item, targetComponents)

}



class ClassDailyHealthSurveyProfile extends Component {
...
}))(Form.create()(ClassDailyHealthSurveyProfile))
