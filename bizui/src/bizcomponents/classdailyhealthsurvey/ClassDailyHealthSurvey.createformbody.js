...
const testValues = {
  ...
  surveyTime: '2020-01-24 00:05:49',
...
class ClassDailyHealthSurveyCreateFormBody extends Component {
  state = {
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.changeRequest} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={ClassDailyHealthSurveyService.requestCandidateChangeRequest}/>
...
}))(Form.create()(ClassDailyHealthSurveyCreateFormBody))
