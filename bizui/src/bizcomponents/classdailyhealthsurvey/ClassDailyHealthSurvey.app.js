...
constructor(props) {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/classDailyHealthSurvey/${this.props.classDailyHealthSurvey.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
  ...
  getDailySurveyQuestionSearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('daily_survey_question','class_daily_health_survey.daily_survey_question_list',false),
      ...
      listName: 'dailySurveyQuestionList', ref:state._classDailyHealthSurvey, 
  ...
  getDailySurveyQuestionCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._classDailyHealthSurvey.dailySurveyQuestionSearchFormParameters,
      loading: state._classDailyHealthSurvey.loading,
      owner: { type: '_classDailyHealthSurvey', id: state._classDailyHealthSurvey.id, referenceName: 'classDailyHealthSurvey', listName: 'dailySurveyQuestionList', ref:state._classDailyHealthSurvey, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getDailySurveyQuestionUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_classDailyHealthSurvey', id: state._classDailyHealthSurvey.id, listName: 'dailySurveyQuestionList', ref:state._classDailyHealthSurvey, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getStudentHealthSurveySearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('student_health_survey','class_daily_health_survey.student_health_survey_list',false),
      ...
      owner: { type: '_classDailyHealthSurvey', id: state._classDailyHealthSurvey.id, 
      referenceName: 'classDailyHealthSurvey', 
      listName: 'studentHealthSurveyList', ref:state._classDailyHealthSurvey, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getStudentHealthSurveyCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._classDailyHealthSurvey.studentHealthSurveySearchFormParameters,
      loading: state._classDailyHealthSurvey.loading,
      owner: { type: '_classDailyHealthSurvey', id: state._classDailyHealthSurvey.id, referenceName: 'classDailyHealthSurvey', listName: 'studentHealthSurveyList', ref:state._classDailyHealthSurvey, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getStudentHealthSurveyUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "studentHealthSurvey",
      currentUpdateIndex: state._classDailyHealthSurvey.currentUpdateIndex,
      owner: { type: '_classDailyHealthSurvey', id: state._classDailyHealthSurvey.id, listName: 'studentHealthSurveyList', ref:state._classDailyHealthSurvey, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	{path:"/classDailyHealthSurvey/:id/permission", component: ClassDailyHealthSurveyPermission},
  	
  	
  	
  	{path:"/classDailyHealthSurvey/:id/list/dailySurveyQuestionList", component: this.getDailySurveyQuestionSearch()},
  	{path:"/classDailyHealthSurvey/:id/list/dailySurveyQuestionCreateForm", component: this.getDailySurveyQuestionCreateForm()},
  	{path:"/classDailyHealthSurvey/:id/list/dailySurveyQuestionUpdateForm", component: this.getDailySurveyQuestionUpdateForm()},
 ...
 <Header style={{ position: 'fixed', zIndex: 1, width: '100%' }}>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.classDailyHealthSurvey,this.state.searchKeyword)}</div>
