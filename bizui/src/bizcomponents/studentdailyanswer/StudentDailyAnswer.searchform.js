...
class StudentDailyAnswerSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      studentDailyAnswerList: 1,
      'studentDailyAnswerList.searchField': fieldName,
      'studentDailyAnswerList.searchVerb': 'startsWith',
      'studentDailyAnswerList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        studentDailyAnswerSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                 <Form.Item label={fieldLabels.studentHealthSurvey}>
               {getFieldDecorator('studentHealthSurvey', {initialValue: tryinit('studentHealthSurvey')})(
               
               <SelectObject 
                 disabled={!availableForEdit('studentHealthSurvey')}
                 targetType={"studentHealthSurvey"} 
                 requestFunction={StudentDailyAnswerService.requestCandidateStudentHealthSurvey} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"question"} 
                    requestFunction={StudentDailyAnswerService.requestCandidateQuestion} useForSearch />
...
export default Form.create()(StudentDailyAnswerSearchForm)
