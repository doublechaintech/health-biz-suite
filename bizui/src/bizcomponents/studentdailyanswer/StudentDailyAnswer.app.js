...
constructor(props) {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/studentDailyAnswer/${this.props.studentDailyAnswer.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
 ...
 <Header style={{ position: 'fixed', zIndex: 1, width: '100%' }}>
      ...
      {this.state.showSearch&&(
        ...
        <div style={{backgroundColor:'black'}}  onClick={()=>hideSearchResult()}  >{searchLocalData(this.props.studentDailyAnswer,this.state.searchKeyword)}</div>
