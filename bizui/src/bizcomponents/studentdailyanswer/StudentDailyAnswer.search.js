...
import styles from './StudentDailyAnswer.search.less'
import ListViewTool from '../../common/ListView.tool'
import StudentDailyAnswerBase from './StudentDailyAnswer.base'
import PermissionSettingService from '../../permission/PermissionSetting.service'
import appLocaleName from '../../common/Locale.tool'
const {fieldLabels} = StudentDailyAnswerBase
...
const showAssociateDialog = (targetComponent) => {
  ...
  const { StudentHealthSurveyAssociateForm } = GlobalComponents
  const { DailySurveyQuestionAssociateForm } = GlobalComponents
  ...
  <div>
	...
	visible={currentAssociateModal==='studentHealthSurvey'} 
	data={{studentDailyAnswerList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'studentHealthSurvey')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'studentHealthSurvey')}/> <DailySurveyQuestionAssociateForm 
...
class StudentDailyAnswerSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {StudentDailyAnswerTable} = GlobalComponents;
    const {StudentDailyAnswerSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <StudentDailyAnswerSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,StudentDailyAnswerModalTable,"studentDailyAnswerIds")}
...
export default Form.create()(StudentDailyAnswerSearch)
