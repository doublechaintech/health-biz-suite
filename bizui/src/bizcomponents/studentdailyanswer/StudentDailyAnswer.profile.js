...
const internalSummaryOf = (item, targetComponents) => {
  return GlobalComponents.StudentDailyAnswerBase.renderItemOfList(item, targetComponents);
};

class StudentDailyAnswerProfile extends Component {
  componentDidMount() {}
...
}))(Form.create()(StudentDailyAnswerProfile));
