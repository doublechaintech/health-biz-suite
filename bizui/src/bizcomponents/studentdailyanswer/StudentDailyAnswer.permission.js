...
<Description term="创建时间">{ moment(studentDailyAnswer.createTime).format('YYYY-MM-DD')}</Description> 
<Description term="最后更新时间">{ moment(studentDailyAnswer.lastUpdateTime).format('YYYY-MM-DD')}</Description> 
...
const renderPermissionSetting = studentDailyAnswer => {
  ...
  return <PermissionSetting targetObject={studentDailyAnswer}  targetObjectMeta={StudentDailyAnswerBase}/>
}
