...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.QuestionTypeBase.renderItemOfList(item, targetComponents)

}



class QuestionTypeProfile extends Component {
...
}))(Form.create()(QuestionTypeProfile))
