...
const menuData = {
  menuName: window.trans('question_type'),
  menuFor: 'questionType',
  subItems: [
    {
      name: 'questionList',
      displayName: window.mtrans('question', 'question_type.question_list', false),
      type: 'question',
      icon: 'question',
...
const displayColumns = [
  {
    ...
    dataIndex: 'id',
    width: '8',
    render: (text, record) => renderTextCell(text, record, 'questionType'),
    sorter: true,
  },
  {
