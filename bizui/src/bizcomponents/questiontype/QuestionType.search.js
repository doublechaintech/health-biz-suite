...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{questionTypeList:selectedRows}} owner={owner}  
...
class QuestionTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {QuestionTypeTable} = GlobalComponents;
    const {QuestionTypeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <QuestionTypeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,QuestionTypeModalTable,"questionTypeIds")}
...
export default Form.create()(QuestionTypeSearch)
