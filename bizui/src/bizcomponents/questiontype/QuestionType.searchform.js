...
import styles from './QuestionType.search.less'
...
class QuestionTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      questionTypeList: 1,
      'questionTypeList.searchField': fieldName,
      'questionTypeList.searchVerb': 'startsWith',
      'questionTypeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        questionTypeSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={QuestionTypeService.requestCandidatePlatform} useForSearch />
...
export default Form.create()(QuestionTypeSearchForm)
