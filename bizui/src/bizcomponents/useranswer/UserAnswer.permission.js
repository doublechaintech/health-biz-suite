...
<Description term="活动主题">{userAnswer.topic}</Description> 
<Description term="问题的答案">{userAnswer.questionAnswer}</Description> 
...
class UserAnswerPermission extends Component {
  ...
  render() {
    ...
    const { id,displayName, dailyAnswerCount, answerQuestionCount } = userAnswer
