...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'user')}/> <UserAnswerAssociateForm 
	visible={currentAssociateModal==='userAnswer'} 
	data={{answerQuestionList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'userAnswer')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'userAnswer')}/> <ChangeRequestAssociateForm 
