...
constructor(props) {
  ...
  getStudentSearch = () => {
    ...
    return connect(state => ({
      ...
      referenceName: 'user', 
      listName: 'studentList', ref:state._user, 
  ...
  getStudentCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._user.studentSearchFormParameters,
      loading: state._user.loading,
      owner: { type: '_user', id: state._user.id, referenceName: 'user', listName: 'studentList', ref:state._user, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
    }))(StudentCreateForm)
  }
  ...
  getStudentUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_user', id: state._user.id, listName: 'studentList', ref:state._user, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(StudentUpdateForm)
  }
  ...
  getQuestionSearch = () => {
    ...
    return connect(state => ({
      ...
      listName: 'questionList', ref:state._user, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(QuestionSearch)
  }
  ...
  getQuestionCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._user.questionSearchFormParameters,
      loading: state._user.loading,
      owner: { type: '_user', id: state._user.id, referenceName: 'creator', listName: 'questionList', ref:state._user, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
    }))(QuestionCreateForm)
  }
  ...
  getQuestionUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "question",
      currentUpdateIndex: state._user.currentUpdateIndex,
      owner: { type: '_user', id: state._user.id, listName: 'questionList', ref:state._user, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
    }))(QuestionUpdateForm)
  }
  ...
  getClassDailyHealthSurveySearch = () => {
    ...
    return connect(state => ({
      rule: state.rule,
      name: window.mtrans('class_daily_health_survey','user.class_daily_health_survey_list',false),
      ...
      owner: { type: '_user', id: state._user.id, 
      referenceName: 'creator', 
      listName: 'classDailyHealthSurveyList', ref:state._user, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getClassDailyHealthSurveyCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._user.classDailyHealthSurveySearchFormParameters,
      loading: state._user.loading,
      owner: { type: '_user', id: state._user.id, referenceName: 'creator', listName: 'classDailyHealthSurveyList', ref:state._user, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getClassDailyHealthSurveyUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "classDailyHealthSurvey",
      currentUpdateIndex: state._user.currentUpdateIndex,
      owner: { type: '_user', id: state._user.id, listName: 'classDailyHealthSurveyList', ref:state._user, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getWechatLoginInfoSearch = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_user', id: state._user.id, 
      referenceName: 'user', 
      listName: 'wechatLoginInfoList', ref:state._user, 
      listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  getWechatLoginInfoCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._user.wechatLoginInfoSearchFormParameters,
      loading: state._user.loading,
      owner: { type: '_user', id: state._user.id, referenceName: 'user', listName: 'wechatLoginInfoList', ref:state._user, listDisplayName: appLocaleName(userContext,"List")}, // this is for model namespace and
  ...
  getWechatLoginInfoUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "wechatLoginInfo",
      currentUpdateIndex: state._user.currentUpdateIndex,
      owner: { type: '_user', id: state._user.id, listName: 'wechatLoginInfoList', ref:state._user, listDisplayName: appLocaleName(userContext,"List") }, // this is for model namespace and
  ...
  buildRouters = () =>{
  	...
  	{path:"/user/:id/list/classDailyHealthSurveyList", component: this.getClassDailyHealthSurveySearch()},
  	{path:"/user/:id/list/classDailyHealthSurveyCreateForm", component: this.getClassDailyHealthSurveyCreateForm()},
  	{path:"/user/:id/list/classDailyHealthSurveyUpdateForm", component: this.getClassDailyHealthSurveyUpdateForm()},
   	
  	{path:"/user/:id/list/wechatLoginInfoList", component: this.getWechatLoginInfoSearch()},
  	{path:"/user/:id/list/wechatLoginInfoCreateForm", component: this.getWechatLoginInfoCreateForm()},
  	{path:"/user/:id/list/wechatLoginInfoUpdateForm", component: this.getWechatLoginInfoUpdateForm()},
   	{path:"/user/:id/ChangeRequestType/:code", component: GlobalComponents.ChangeRequestStepForm},
