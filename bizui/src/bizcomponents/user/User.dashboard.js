...
const imageList = user => {
  return [{ title: '头像', imageLocation: user.avatar }];
};
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/user/${targetComponent.props.user.id}/permission`}>
    ...
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="地址">
        {user.address == null
          ...
          : `${user.address.displayName}(${user.address.id})`}
        <Icon
          type="swap"
          onClick={() =>
            showTransferModel(
              ...
              '地址',
              'location',
              UserService.requestCandidateAddress,
              UserService.transferToAnotherAddress,
              'anotherAddressId',
...
class UserDashboard extends Component {
  ...
  render() {
    ...
    const {
      ...
      teacherListMetaInfo,
      studentListMetaInfo,
      questionListMetaInfo,
      classDailyHealthSurveyListMetaInfo,
      wechatLoginInfoListMetaInfo,
      teacherCount,
      studentCount,
      questionCount,
      classDailyHealthSurveyCount,
      wechatLoginInfoCount,
    } = this.props.user;
    ...
    const cardsData = {
      cardsName: '用户',
      cardsFor: 'user',
      cardsSource: this.props.user,
      returnURL,
      displayName,
      subItems: [
        {
          name: 'teacherList',
          displayName: window.mtrans('teacher', 'user.teacher_list', false),
          viewGroup: '__no_group',
          type: 'teacher',
          count: teacherCount,
          addFunction: true,
          role: 'teacher',
          metaInfo: teacherListMetaInfo,
          renderItem: GlobalComponents.TeacherBase.renderItemOfList,
        },
        {
          name: 'studentList',
          displayName: window.mtrans('student', 'user.student_list', false),
          viewGroup: '__no_group',
          type: 'student',
          count: studentCount,
          addFunction: true,
          role: 'student',
          metaInfo: studentListMetaInfo,
          renderItem: GlobalComponents.StudentBase.renderItemOfList,
        },
        {
          name: 'questionList',
          displayName: window.mtrans('question', 'user.question_list', false),
          viewGroup: '__no_group',
          type: 'question',
          count: questionCount,
          addFunction: true,
          role: 'question',
          metaInfo: questionListMetaInfo,
          renderItem: GlobalComponents.QuestionBase.renderItemOfList,
        },
        {
        ...
        },
        {
          ...
          displayName: window.mtrans('wechat_login_info', 'user.wechat_login_info_list', false),
          viewGroup: '__no_group',
          type: 'wechatLoginInfo',
          count: wechatLoginInfoCount,
          addFunction: true,
          role: 'wechatLoginInfo',
          metaInfo: wechatLoginInfoListMetaInfo,
