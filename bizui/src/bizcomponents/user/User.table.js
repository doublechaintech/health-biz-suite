...
import styles from './User.table.less'
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
          ...
          { hasReadPermission(metaInfo)&&<Link to={`/user/${record.id}/dashboard`}>{appLocaleName(userContext,"View")}</Link>}
