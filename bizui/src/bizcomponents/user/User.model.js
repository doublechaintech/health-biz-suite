...
export default {
  ...
  effects: {
    ...
    *addTeacher({ payload }, { call, put }) {
      ...
      const data = yield call(UserService.addTeacher, id, parameters);
      if (hasError(data)) {
      ...
      const location = {
        pathname: `/user/${id}/list/TeacherList/老师+${appLocaleName(userContext, 'List')}`,
        state: newState,
      };
      yield put(routerRedux.push(location));
    },
    *updateTeacher({ payload }, { call, put }) {
      ...
      console.log('get form parameters', parameters);
      const data = yield call(UserService.updateTeacher, id, parameters);
      if (hasError(data)) {
        handleServerError(data);
        return;
      }
      ...
      const location = { pathname: `/user/${id}/list/TeacherList/老师列表`, state: newPlayload };
      yield put(routerRedux.push(location));
    },
    ...
    *removeTeacherList({ payload }, { call, put }) {
      ...
      const { id, role, parameters, continueNext } = payload;
      console.log('get form parameters', parameters);
      const data = yield call(UserService.removeTeacherList, id, parameters);
      if (hasError(data)) {
        handleServerError(data);
        return;
      }
    ...
    *addStudent({ payload }, { call, put }) {
      ...
      const newState = { ...data, partialList };
      const location = {
        pathname: `/user/${id}/list/StudentList/学生+${appLocaleName(userContext, 'List')}`,
        state: newState,
      };
      yield put(routerRedux.push(location));
    },
    ...
    *addQuestion({ payload }, { call, put }) {
      ...
      const newState = { ...data, partialList };
      const location = {
        pathname: `/user/${id}/list/QuestionList/检查问题+${appLocaleName(userContext, 'List')}`,
        state: newState,
      };
      yield put(routerRedux.push(location));
    },
    *updateQuestion({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/user/${id}/list/QuestionList/检查问题列表`,
        state: newPlayload,
      };
      yield put(routerRedux.push(location));
    },
    ...
    *addClassDailyHealthSurvey({ payload }, { call, put }) {
      ...
      const newState = { ...data, partialList };
      const location = {
        pathname: `/user/${id}/list/ClassDailyHealthSurveyList/每日健康调查+${appLocaleName(
          userContext,
          'List'
        )}`,
        state: newState,
    ...
    *updateClassDailyHealthSurvey({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/user/${id}/list/ClassDailyHealthSurveyList/每日健康调查列表`,
        state: newPlayload,
      };
      yield put(routerRedux.push(location));
    },
    ...
    *addWechatLoginInfo({ payload }, { call, put }) {
      ...
      const newState = { ...data, partialList };
      const location = {
        pathname: `/user/${id}/list/WechatLoginInfoList/微信登录信息+${appLocaleName(
          userContext,
          'List'
        )}`,
        state: newState,
    ...
    *updateWechatLoginInfo({ payload }, { call, put }) {
      ...
      const location = {
        pathname: `/user/${id}/list/WechatLoginInfoList/微信登录信息列表`,
        state: newPlayload,
      };
      yield put(routerRedux.push(location));
    },
