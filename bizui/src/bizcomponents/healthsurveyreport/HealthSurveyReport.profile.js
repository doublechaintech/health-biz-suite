...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.HealthSurveyReportBase.renderItemOfList(item, targetComponents)

}



class HealthSurveyReportProfile extends Component {
...
}))(Form.create()(HealthSurveyReportProfile))
