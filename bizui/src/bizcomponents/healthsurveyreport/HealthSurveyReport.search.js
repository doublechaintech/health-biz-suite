  ...
  return (
    <div>
      <StudentAssociateForm
        ...
        data={{ healthSurveyReportList: selectedRows }}
        owner={owner}
        onCancel={() => toggleAssociateModalVisible(targetComponent, 'student')}
        onCreate={() => toggleAssociateModalVisible(targetComponent, 'student')}
      />{' '}
      <TeacherAssociateForm
        ...
        onCreate={() => toggleAssociateModalVisible(targetComponent, 'teacher')}
      />{' '}
