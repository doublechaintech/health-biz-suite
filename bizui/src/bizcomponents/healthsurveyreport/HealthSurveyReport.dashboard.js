...
const internalSettingListOf = healthSurveyReport =>
  defaultSettingListOf(healthSurveyReport, optionList);
...
const renderSettingMenuItem = (item, cardsData, targetComponent) => {
  ...
  return (
    <Menu.Item key={item.name}>
      <Link
        to={`/healthSurveyReport/${targetComponent.props.healthSurveyReport.id}/list/${item.name}/${
          item.displayName
        }/`}
      >
  ...
  return (
    <Menu>
      <Menu.Item key="profile">
        <Link to={`/healthSurveyReport/${targetComponent.props.healthSurveyReport.id}/permission`}>
...
const internalSummaryOf = (healthSurveyReport, targetComponent) => {
  ...
  return (
    <DescriptionList className={styles.headerList} size="small" col="4">
      ...
      <Description term="调查的名字" style={{ wordBreak: 'break-all' }}>
        {healthSurveyReport.surveyName}
      </Description>
      <Description term="调查的时间">
        {moment(healthSurveyReport.surveyTime).format('YYYY-MM-DD HH:mm')}
      </Description>
      <Description term="老师的名字" style={{ wordBreak: 'break-all' }}>
      ...
      <Description term="学生的名字" style={{ wordBreak: 'break-all' }}>
        {healthSurveyReport.studentName}
      </Description>
      <Description term="学生数量" style={{ wordBreak: 'break-all' }}>
        {healthSurveyReport.studentNumber}
      </Description>
      <Description term="监护人姓名" style={{ wordBreak: 'break-all' }}>
        {healthSurveyReport.guardianName}
      </Description>
      <Description term="监护人手机" style={{ wordBreak: 'break-all' }}>
        ...
        <Icon
          ...
          onClick={() =>
            showTransferModel(
              ...
              '学生',
              'student',
              HealthSurveyReportService.requestCandidateStudent,
              HealthSurveyReportService.transferToAnotherStudent,
              'anotherStudentId',
              healthSurveyReport.student ? healthSurveyReport.student.id : ''
            )
          }
        ...
        <Icon
          ...
          onClick={() =>
            showTransferModel(
              ...
              '老师',
              'teacher',
              HealthSurveyReportService.requestCandidateTeacher,
              HealthSurveyReportService.transferToAnotherTeacher,
              'anotherTeacherId',
              healthSurveyReport.teacher ? healthSurveyReport.teacher.id : ''
            )
          }
          style={{ fontSize: 20, color: 'red' }}
        />
        ...
        <Icon
          ...
          onClick={() =>
            showTransferModel(
              ...
              HealthSurveyReportService.requestCandidateSurvey,
              HealthSurveyReportService.transferToAnotherSurvey,
              'anotherSurveyId',
              healthSurveyReport.survey ? healthSurveyReport.survey.id : ''
            )
          }
          style={{ fontSize: 20, color: 'red' }}
        />
...
class HealthSurveyReportDashboard extends Component {
  ...
  render() {
    ...
    const {
      id,
      displayName,
      studentAnswerListMetaInfo,
      studentAnswerCount,
    } = this.props.healthSurveyReport;
    ...
    const cardsData = {
      ...
      cardsSource: this.props.healthSurveyReport,
      returnURL,
      displayName,
      subItems: [
        {
          ...
          type: 'studentAnswer',
          count: studentAnswerCount,
          addFunction: true,
          role: 'studentAnswer',
          metaInfo: studentAnswerListMetaInfo,
          renderItem: GlobalComponents.StudentAnswerBase.renderItemOfList,
        },
      ],
      subSettingItems: [],
    };
