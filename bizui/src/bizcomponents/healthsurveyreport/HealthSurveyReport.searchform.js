  ...
  */
  ...
  handleSearch = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'surveyName')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'teacherName')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'school')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'contains', 'schoolClass')
      );
      pushIfNotNull(
        paramList,
      ...
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'eq', 'student')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'eq', 'teacher')
      );
      pushIfNotNull(
        paramList,
        this.buildStringSearchParameters(listName, fieldsValue, 'eq', 'survey')
      );
