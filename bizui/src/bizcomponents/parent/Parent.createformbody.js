...
class ParentCreateFormBody extends Component {
  state = {
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.address} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"address"} 
                    requestFunction={ParentService.requestCandidateAddress}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.wechatUser} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={ParentService.requestCandidateWechatUser}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.platform} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={ParentService.requestCandidatePlatform}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.cq} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"cq"} 
                    requestFunction={ParentService.requestCandidateCq}/>
...
}))(Form.create()(ParentCreateFormBody))
