...
import styles from './Parent.search.less'
...
class ParentSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      parentList: 1,
      'parentList.searchField': fieldName,
      'parentList.searchVerb': 'startsWith',
      'parentList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        parentSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"address"} 
                    requestFunction={ParentService.requestCandidateAddress} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={ParentService.requestCandidateWechatUser} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={ParentService.requestCandidatePlatform} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"cq"} 
                    requestFunction={ParentService.requestCandidateCq} useForSearch />
...
export default Form.create()(ParentSearchForm)
