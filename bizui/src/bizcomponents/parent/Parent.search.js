...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{parentList:selectedRows}} owner={owner}  
...
class ParentSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ParentTable} = GlobalComponents;
    const {ParentSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,ParentModalTable,"parentIds")}
...
export default Form.create()(ParentSearch)
