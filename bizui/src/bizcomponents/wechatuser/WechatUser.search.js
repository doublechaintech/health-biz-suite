...
const showAssociateDialog = (targetComponent) => {
  ...
  const { UserTypeAssociateForm } = GlobalComponents
  ...
  <div>
	...
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'address')}/> <UserTypeAssociateForm 
	visible={currentAssociateModal==='userType'} 
	data={{wechatUserList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'userType')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'userType')}/> <PlatformAssociateForm 
