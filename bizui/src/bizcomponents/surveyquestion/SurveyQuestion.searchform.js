...
import styles from './SurveyQuestion.search.less'
...
class SurveyQuestionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      surveyQuestionList: 1,
      'surveyQuestionList.searchField': fieldName,
      'surveyQuestionList.searchVerb': 'startsWith',
      'surveyQuestionList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        surveyQuestionSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"survey"} 
                    requestFunction={SurveyQuestionService.requestCandidateSurvey} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"question"} 
                    requestFunction={SurveyQuestionService.requestCandidateQuestion} useForSearch />
...
export default Form.create()(SurveyQuestionSearchForm)
