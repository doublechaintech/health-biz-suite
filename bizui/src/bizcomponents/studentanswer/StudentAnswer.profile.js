...
const internalSummaryOf = (item, targetComponents) => {
  return GlobalComponents.StudentAnswerBase.renderItemOfList(item, targetComponents);
};

class StudentAnswerProfile extends Component {
  componentDidMount() {}
...
}))(Form.create()(StudentAnswerProfile));
