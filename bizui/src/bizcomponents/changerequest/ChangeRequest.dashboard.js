...
<Description term="ID" style={{wordBreak: 'break-all'}}>{changeRequest.id}</Description> 
<Description term="名称" style={{wordBreak: 'break-all'}}>{changeRequest.name}</Description> 
<Description term="创建时间">{ moment(changeRequest.createTime).format('YYYY-MM-DD HH:mm')}</Description> 
<Description term="访问IP" style={{wordBreak: 'break-all'}}>{changeRequest.remoteIp}</Description> 
