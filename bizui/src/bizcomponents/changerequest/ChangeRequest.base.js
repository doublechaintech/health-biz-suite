...
const menuData = {menuName: window.trans('change_request'), menuFor: "changeRequest",
  		subItems: [
  {name: 'schoolClassList', displayName: window.mtrans('school_class','change_request.school_class_list',false), type:'schoolClass',icon:'school',readPermission: false,createPermission: false,deletePermission: false,updatePermission: false,executionPermission: false, viewGroup: '__no_group'},
  ...
  {name: 'guardianList', displayName: window.mtrans('guardian','change_request.guardian_list',false), type:'guardian',icon:'500px',readPermission: false,createPermission: false,deletePermission: false,updatePermission: false,executionPermission: false, viewGroup: '__no_group'},
  {name: 'classQuestionList', displayName: window.mtrans('class_question','change_request.class_question_list',false), type:'classQuestion',icon:'question',readPermission: false,createPermission: false,deletePermission: false,updatePermission: false,executionPermission: false, viewGroup: '__no_group'},
  ...
  {name: 'studentList', displayName: window.mtrans('student','change_request.student_list',false), type:'student',icon:'500px',readPermission: false,createPermission: false,deletePermission: false,updatePermission: false,executionPermission: false, viewGroup: '__no_group'},
  ...
  {name: 'studentDailyAnswerList', displayName: window.mtrans('student_daily_answer','change_request.student_daily_answer_list',false), type:'studentDailyAnswer',icon:'500px',readPermission: false,createPermission: false,deletePermission: false,updatePermission: false,executionPermission: false, viewGroup: '__no_group'},
