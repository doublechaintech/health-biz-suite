...
const buildSteps = (targetComponent, stepCode) => {
  ...
  stepCollection['ANSWER_SURVEY'] = [
    ...
    studentHealthSurveyStepOf(
      targetComponent,
      '创建学生健康调查',
      <StudentHealthSurveyCreateFormBody {...targetComponent.props} hideTitle />,
  ...
  stepCollection['REGISTER_TEACHER'] = [
    ...
    teacherStepOf(
      targetComponent,
      '创建老师',
      <TeacherCreateFormBody {...targetComponent.props} hideTitle />,
      'teacherList',
      0
    ),
    completeStep(),
  ...
  stepCollection['CREATE_SURVEY'] = [
    ...
    classDailyHealthSurveyStepOf(
      targetComponent,
      '创建每日健康调查',
      <ClassDailyHealthSurveyCreateFormBody {...targetComponent.props} hideTitle />,
  ...
  stepCollection['ANSWER_QUESTION'] = [
    ...
    studentDailyAnswerStepOf(
      targetComponent,
      '创建学生每天回答',
      <StudentDailyAnswerCreateFormBody {...targetComponent.props} hideTitle />,
  ...
  stepCollection['CREATE_QUESTION'] = [
    ...
    questionStepOf(
      targetComponent,
      '创建检查问题',
      <QuestionCreateFormBody {...targetComponent.props} hideTitle />,
      'questionList',
      0
    ),
    completeStep(),
  ...
  stepCollection['REGISTER_STUDENT'] = [
    ...
    studentStepOf(
      targetComponent,
      '创建学生',
      <StudentCreateFormBody {...targetComponent.props} hideTitle />,
      'studentList',
      0
    ),
    completeStep(),
  ...
  alert(`Steps with code '${stepCode}' are empty`);
  return [];
};
