...
<Description term="访问IP">{changeRequest.remoteIp}</Description> 
...
class ChangeRequestPermission extends Component {
  ...
  render() {
    ...
    const { id,displayName, schoolClassCount, teacherCount, guardianCount, classQuestionCount, classDailyHealthSurveyCount, studentCount, studentHealthSurveyCount, studentDailyAnswerCount } = changeRequest
