...
class ChangeRequestPermission extends Component {
  ...
  render() {
    ...
    const { id,displayName, teacherCount, studentCount, questionCount, classDailyHealthSurveyCount, studentHealthSurveyCount, studentDailyAnswerCount } = changeRequest
