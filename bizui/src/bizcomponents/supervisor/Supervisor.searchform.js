...
import styles from './Supervisor.search.less'
...
class SupervisorSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      supervisorList: 1,
      'supervisorList.searchField': fieldName,
      'supervisorList.searchVerb': 'startsWith',
      'supervisorList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        supervisorSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={SupervisorService.requestCandidatePlatform} useForSearch />
...
export default Form.create()(SupervisorSearchForm)
