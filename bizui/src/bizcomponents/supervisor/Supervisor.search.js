...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{supervisorList:selectedRows}} owner={owner}  
...
class SupervisorSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SupervisorTable} = GlobalComponents;
    const {SupervisorSearchForm} = GlobalComponents;
    const {SupervisorModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SupervisorSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SupervisorModalTable,"supervisorIds")}
...
export default Form.create()(SupervisorSearch)
