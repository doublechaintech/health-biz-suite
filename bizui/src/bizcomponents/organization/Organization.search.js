...
const showAssociateDialog = (targetComponent) => {
  ...
  const { SupervisorAssociateForm } = GlobalComponents
  ...
  <div>
    ...
    <SupervisorAssociateForm 
	visible={currentAssociateModal==='supervisor'} 
	data={{organizationList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'supervisor')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'supervisor')}/> <DistrictAssociateForm 
	visible={currentAssociateModal==='district'} 
	data={{organizationList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'district')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'district')}/> <PlatformAssociateForm 
