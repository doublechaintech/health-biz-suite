...
componentDidMount() {
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'supervisor'))
 ...
 <Col md={8} sm={24}>
                    <Form.Item label={fieldLabels.supervisor}>
                  {getFieldDecorator('supervisor', {initialValue: tryinit('supervisor')})(
                  
                  <SelectObject 
                    disabled={!availableForEdit('supervisor')}
                    targetType={"supervisor"} 
                    requestFunction={OrganizationService.requestCandidateSupervisor} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"district"} 
                    requestFunction={OrganizationService.requestCandidateDistrict} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={OrganizationService.requestCandidatePlatform} useForSearch />
