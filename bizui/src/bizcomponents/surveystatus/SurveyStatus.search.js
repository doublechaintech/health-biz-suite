...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{surveyStatusList:selectedRows}} owner={owner}  
...
class SurveyStatusSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {SurveyStatusTable} = GlobalComponents;
    const {SurveyStatusSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <SurveyStatusSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,SurveyStatusModalTable,"surveyStatusIds")}
...
export default Form.create()(SurveyStatusSearch)
