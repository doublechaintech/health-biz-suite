...
import styles from './SurveyStatus.search.less'
...
class SurveyStatusSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      surveyStatusList: 1,
      'surveyStatusList.searchField': fieldName,
      'surveyStatusList.searchVerb': 'startsWith',
      'surveyStatusList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        surveyStatusSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={SurveyStatusService.requestCandidatePlatform} useForSearch />
...
export default Form.create()(SurveyStatusSearchForm)
