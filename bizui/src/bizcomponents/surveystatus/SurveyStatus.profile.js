...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.SurveyStatusBase.renderItemOfList(item, targetComponents)

}



class SurveyStatusProfile extends Component {
...
}))(Form.create()(SurveyStatusProfile))
