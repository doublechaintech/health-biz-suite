...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.DailySurveyQuestionBase.renderItemOfList(item, targetComponents)

}



class DailySurveyQuestionProfile extends Component {
...
}))(Form.create()(DailySurveyQuestionProfile))
