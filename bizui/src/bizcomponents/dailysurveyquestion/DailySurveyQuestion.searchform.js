...
class DailySurveyQuestionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      dailySurveyQuestionList: 1,
      'dailySurveyQuestionList.searchField': fieldName,
      'dailySurveyQuestionList.searchVerb': 'startsWith',
      'dailySurveyQuestionList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'questionType'))
      ...
      dispatch({
        ...
        dailySurveyQuestionSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                 <Form.Item label={fieldLabels.questionType}>
               {getFieldDecorator('questionType', {initialValue: tryinit('questionType')})(
               
               <SelectObject 
                 disabled={!availableForEdit('questionType')}
                 targetType={"questionType"} 
                 requestFunction={DailySurveyQuestionService.requestCandidateQuestionType} useForSearch />
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.topic}>
 ...
 <Col md={8} sm={24}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.optionA}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.optionB}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.optionC}>
          ...
          <Col md={8} sm={24}>
            <FormItem label={fieldLabels.optionD}>
 ...
 <Col md={8} sm={24}>
                    <Form.Item label={fieldLabels.classDailyHealthSurvey}>
                  {getFieldDecorator('classDailyHealthSurvey', {initialValue: tryinit('classDailyHealthSurvey')})(
                  
                  <SelectObject 
                    disabled={!availableForEdit('classDailyHealthSurvey')}
                    targetType={"classDailyHealthSurvey"} 
                    requestFunction={DailySurveyQuestionService.requestCandidateClassDailyHealthSurvey} useForSearch />
...
export default Form.create()(DailySurveyQuestionSearchForm)
