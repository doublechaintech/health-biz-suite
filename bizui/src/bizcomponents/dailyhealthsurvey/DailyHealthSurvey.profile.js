...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.DailyHealthSurveyBase.renderItemOfList(item, targetComponents)

}



class DailyHealthSurveyProfile extends Component {
...
}))(Form.create()(DailyHealthSurveyProfile))
