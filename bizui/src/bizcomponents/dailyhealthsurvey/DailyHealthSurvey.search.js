...
import styles from './DailyHealthSurvey.search.less'
...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{dailyHealthSurveyList:selectedRows}} owner={owner}  
...
class DailyHealthSurveySearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {DailyHealthSurveyTable} = GlobalComponents;
    const {DailyHealthSurveySearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <DailyHealthSurveySearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,DailyHealthSurveyModalTable,"dailyHealthSurveyIds")}
...
export default Form.create()(DailyHealthSurveySearch)
