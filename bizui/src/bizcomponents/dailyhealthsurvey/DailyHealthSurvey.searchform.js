...
class DailyHealthSurveySearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      dailyHealthSurveyList: 1,
      'dailyHealthSurveyList.searchField': fieldName,
      'dailyHealthSurveyList.searchVerb': 'startsWith',
      'dailyHealthSurveyList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        dailyHealthSurveySearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={DailyHealthSurveyService.requestCandidateOrganization} useForSearch />
...
export default Form.create()(DailyHealthSurveySearchForm)
