...
class GuardianCreateFormBody extends Component {
  state = {
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.address} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"address"} 
                    requestFunction={GuardianService.requestCandidateAddress}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.wechatUser} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={GuardianService.requestCandidateWechatUser}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.platform} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={GuardianService.requestCandidatePlatform}/>
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.cq} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"cq"} 
                    requestFunction={GuardianService.requestCandidateCq}/>
...
}))(Form.create()(GuardianCreateFormBody))
