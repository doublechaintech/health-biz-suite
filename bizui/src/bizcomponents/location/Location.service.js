...
const addStudent = (targetObjectId, parameters) => {
  const url = `${PREFIX}locationManager/addStudent/locationId/studentName/studentNumber/studentAvatar/guardianName/guardianMobile/userId/platformId/changeRequestId/tokensExpr/`;
