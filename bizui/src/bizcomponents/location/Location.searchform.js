...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      locationList: 1,
      'locationList.searchField': fieldName,
      'locationList.searchVerb': 'startsWith',
      'locationList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'province'))
      ...
      dispatch({
        ...
        locationSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"district"} 
                    requestFunction={LocationService.requestCandidateDistrict} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  {getFieldDecorator('province', {initialValue: tryinit('province')})(
                  
                  <SelectObject 
                    disabled={!availableForEdit('province')}
                    targetType={"province"} 
                    requestFunction={LocationService.requestCandidateProvince} useForSearch />
...
export default Form.create()(LocationSearchForm)
