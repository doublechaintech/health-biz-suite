...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{userTypeList:selectedRows}} owner={owner}  
...
class UserTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {UserTypeTable} = GlobalComponents;
    const {UserTypeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,UserTypeModalTable,"userTypeIds")}
...
export default Form.create()(UserTypeSearch)
