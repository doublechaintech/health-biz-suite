...
import styles from './UserType.search.less'
...
class UserTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      userTypeList: 1,
      'userTypeList.searchField': fieldName,
      'userTypeList.searchVerb': 'startsWith',
      'userTypeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        userTypeSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={UserTypeService.requestCandidatePlatform} useForSearch />
...
export default Form.create()(UserTypeSearchForm)
