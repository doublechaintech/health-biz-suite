...
import styles from './QuestionSource.search.less'
...
class QuestionSourceSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      questionSourceList: 1,
      'questionSourceList.searchField': fieldName,
      'questionSourceList.searchVerb': 'startsWith',
      'questionSourceList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        questionSourceSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={QuestionSourceService.requestCandidatePlatform} useForSearch />
...
export default Form.create()(QuestionSourceSearchForm)
