...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{questionSourceList:selectedRows}} owner={owner}  
...
class QuestionSourceSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {QuestionSourceTable} = GlobalComponents;
    const {QuestionSourceSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <QuestionSourceSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,QuestionSourceModalTable,"questionSourceIds")}
...
export default Form.create()(QuestionSourceSearch)
